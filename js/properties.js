$(document).ready(function() {
    const propertiesData = {
        ...
        reality: {
            description: "Location: Addis Ababa, Gofa",
            listings: [
                { img: "images/realityproperty1.png", title: "Reality Real Estate" },
            ]
        },
        temer: {
            description: "Location: Addis Ababa, Gerji",
            listings: [
                    ...
                    <div class="col-md-3 col-sm-6">
                        <a href="${requestUrl}" class="product_box_link">
                            <div class="product_box">
                                <figure><img src="${property.img}" alt="${property.title}"/></figure>
